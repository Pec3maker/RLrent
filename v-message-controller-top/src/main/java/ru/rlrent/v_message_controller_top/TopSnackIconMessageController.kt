package ru.rlrent.v_message_controller_top
...
import ru.android.rlrent.v_message_controller_top.R
import ru.surfstudio.android.core.ui.provider.ActivityProvider

/**
 * Класс позволяющий отображать уведомления вверху текущей активити.
 */
class TopSnackIconMessageController(private val activityProvider: ActivityProvider) :
    ...
    override fun show(
        ...
        val backgroundColorTintRes = backgroundColor ?: R.color.errorContainer
