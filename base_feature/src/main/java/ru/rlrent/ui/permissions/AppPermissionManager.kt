...
import ru.surfstudio.android.core.ui.permission.PermissionStatus
...
class AppPermissionManager(
    ...
    private fun performPermissionRequestByDialogOrSettings(
        ...
        when {
            permissionStatus != PermissionStatus.DENIED_FOREVER -> performPermissionRequest(
                permissionRequest
            )
    ...
    private fun performPermissionRequest(permissionRequest: PermissionRequest): Single<Boolean> {
